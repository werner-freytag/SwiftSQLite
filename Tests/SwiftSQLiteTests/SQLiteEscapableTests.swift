...
class SQLiteEscapableTests: XCTestCase {
    ...
    static var allTests = [
        ("testStringSqliteEscaped", testStringSqliteEscaped),
        ("testBoolSqliteEscaped", testBoolSqliteEscaped),
        ("testIntSqliteEscaped", testIntSqliteEscaped),
        ("testDoubleSqliteEscaped", testDoubleSqliteEscaped),
    ]
}
